...
const changeState = () => setState({ opened: !state.opened })
...
<>
  <Switcher onChange={changeState} checked={state.opened}>Open tooltip</Switcher>
  <div>
    {'Lorem ipsum dolor sit amet, consectetur adipisicing elit. '}
    <Tooltip className={styles.inText} content='Tooltip content' tag='span'>Tooltip on text.</Tooltip>
    {' Lorem ipsum dolor sit amet, consectetur adipisicing elit.'}
  </div>
  <Tooltip className={styles.toLeft} content={largeText} opened={state.opened}>Always opened tooltop</Tooltip>
  <Tooltip className={styles.toLeft} content={largeText}>Tooltip on text</Tooltip>
