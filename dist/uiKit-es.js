import React__default, { createElement, createRef, Component, forwardRef, Fragment, PureComponent, useState } from 'react';
...
var styles = {
  ...
  success:
  /*#__PURE__*/
  css("border-color:", colors.intentSuccessBorder, ";background-color:", colors.intentSuccessBg, ";"),
  error:
  /*#__PURE__*/
  css("border-color:", colors.intentDangerBorder, ";background-color:", colors.intentDangerBg, ";")
};
...
var intentStyles = {
  base:
  /*#__PURE__*/
  css$1("border-color:", colors.intentBase, ";background-color:white;color:rgba(0,0,0,0.65);&:focus,&:hover{box-shadow:0px 10px 15px rgba(0,0,0,0.05);}"),
  primary:
  /*#__PURE__*/
  css$1("border-color:", colors.intentPrimary, ";background-color:", colors.intentPrimary, ";color:#ffffff;&:focus,&:hover{box-shadow:0px 10px 15px ", rgba(colors.intentPrimary, 0.15), ";}"),
  secondary:
  /*#__PURE__*/
  css$1("border-color:", rgba(colors.intentPrimary, 0.25), ";background-color:white;color:", rgba(colors.intentPrimary, 0.65), ";&:focus,&:hover{border-color:", colors.intentPrimary, ";color:", colors.intentPrimary, ";box-shadow:0px 10px 15px ", rgba(colors.intentPrimary, 0.15), ";}"),
  iconic:
  /*#__PURE__*/
  css$1("border-color:transparent;background-color:transparent;color:", rgba(colors.intentPrimary, 0.65), ";&:focus,&:hover{border-color:", rgba(colors.intentBase, 0.45), ";color:", colors.intentPrimary, ";box-shadow:0px 10px 15px ", rgba(colors.intentPrimary, 0.15), ";}"),
  plain:
  /*#__PURE__*/
  css$1("border-color:transparent;background-color:transparent;color:", rgba(colors.intentPrimary, 0.65), ";&:focus,&:hover{border-color:", colors.intentPrimary, ";color:", colors.intentPrimary, ";box-shadow:0px 10px 15px ", rgba(colors.intentPrimary, 0.15), ";}")
};
var intentActiveStyles = {
  base:
  /*#__PURE__*/
  css$1("&:active{border-color:", rgba(colors.intentBase, 0.45), ";background-color:", colors.intentBaseActive, ";color:rgba(0,0,0,0.65);box-shadow:none;}"),
  primary:
  /*#__PURE__*/
  css$1("&:active{border-color:", colors.activeAction, ";background-color:", colors.activeAction, ";box-shadow:none;}"),
  secondary:
  /*#__PURE__*/
  css$1("&:active{border-color:", colors.activeAction, ";color:", colors.activeAction, ";box-shadow:none;}"),
  iconic:
  /*#__PURE__*/
  css$1("&:active{border-color:", colors.intentBaseActive, ";background-color:", colors.intentBaseActive, ";color:", colors.activeAction, ";box-shadow:none;}"),
  plain:
  /*#__PURE__*/
  css$1("&:active{border-color:", colors.activeAction, ";color:", colors.activeAction, ";box-shadow:none;}")
};
var intentLoadingStyles = {
  base:
  /*#__PURE__*/
  css$1("border-color:", colors.intentBase, ";"),
  primary:
  /*#__PURE__*/
  css$1(),
  secondary:
  /*#__PURE__*/
  css$1("border-color:", colors.intentPrimary, ";"),
  iconic:
  /*#__PURE__*/
  css$1("border-color:", rgba(colors.intentBase, 0.45), ";"),
  plain:
  /*#__PURE__*/
  css$1("border-color:", colors.intentPrimary, ";")
};
var spinnerStyles = {
  ...
  secondary:
  /*#__PURE__*/
  css$1("fill:", colors.activeAction, ";"),
  iconic:
  /*#__PURE__*/
  css$1("fill:", colors.activeAction, ";"),
  plain:
...
var Button = forwardRef(function (_ref, ref) {
  ...
  if (Icon) {
    ...
    /*#__PURE__*/
    createElement(Icon, {
      className: cx$1(styles$L.icon, _defineProperty({}, styles$L.iconMargin, !isOnlyIcon))
    }));
  }
  ...
  if (IconRight && !isOnlyIcon) {
    ...
    createElement(IconRight, {
      className: cx$1(styles$L.icon, styles$L.iconRightMargin)
    }));
  }
...
var ControlsPanel = function ControlsPanel(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("div", {
      className: cx(styles$N.outer, className)
    }, controls && controls.map(function (control) {
      return control ?
      /*#__PURE__*/
      createElement("div", {
        className: cx(styles$N.control, _defineProperty({}, styles$N.thin, thin))
      }, control) : null;
    }))
  );
};
...
var PopupFooter = function PopupFooter(_ref) {
  ...
  return (
    ...
    createElement(ControlsPanel, {
      className: cx(styles$O.controls),
      controls: controls,
      thin: true
    }))
  );
...
var styles$P = {
  ...
  title:
  /*#__PURE__*/
  css("flex-shrink:0;padding-bottom:16px;padding-right:24px;border-bottom:1px solid ", colors.intentBaseBg, ";margin-bottom:16px;padding-left:16px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"),
  closeIcon:
  /*#__PURE__*/
  css("position:absolute;top:16px;right:16px;"),
  children:
  /*#__PURE__*/
  css("flex-grow:1;padding-left:16px;padding-right:16px;"),
  childrenThin:
  /*#__PURE__*/
    ...
    value: function renderModal() {
      ...
      return (
        ...
        createElement(Component, {
          className: cx(styles$1.baseModal, styles$P.modal, (_cx = {}, _defineProperty(_cx, styles$P.fit, fit), _defineProperty(_cx, styles$1.wide, wide), _cx), className),
          ref: this.modalRef,
          tabIndex: 0,
          onKeyDown: this.handleEscapePress,
          onSubmit: onSubmit
        ...
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$P.children, _defineProperty({}, styles$P.childrenThin, thinBorders))
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return (
          ...
          createElement(Component$1, Object.assign({}, props, {
            className: cx(styles$Q.wrapper, className),
      ...
      value: function renderTooltip() {
        ...
        return (
          /*#__PURE__*/
          createElement("div", {
            className: cx(textStyles.p, styles$Q.tooltip({
              cornerPositionX: cornerPositionX
...
var styles$R = {
  ...
  popover:
  /*#__PURE__*/
  css("position:absolute;left:0;max-width:70%;max-height:100%;padding:8px 0;overflow:hidden;border-radius:4px;box-shadow:0 5px 20px 0 rgba(0,0,0,0.09);border:solid 1px ", colors.intentBaseBg, ";background-color:#ffffff;z-index:", zIndex.dropdownMenu, ";box-sizing:border-box;user-select:none;"),
  popoverScrollable:
  /*#__PURE__*/
  css("height:100%;"),
  // list: css`
  ...
  item: function item() {
    ...
    return (
      /*#__PURE__*/
      css("padding:0 16px;line-height:32px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:", color, ";&:hover{cursor:pointer;background-color:", colors.intentBaseActive, ";}")
    );
  },
  divider:
  /*#__PURE__*/
...
var withDropdown = function withDropdown(Component) {
  ...
  function (_React$PureComponent) {
    ...
    function Dropdown() {
      ...
      _this.throttledRecalcPosition = throttle(_this.recalcPosition, 33);
      ...
      _this.renderPopover = function () {
        ...
        return (
          /*#__PURE__*/
          createElement("div", {
            className: cx(styles$R.popover, _defineProperty({}, styles$R.popoverScrollable, useScroll), popoverClassName),
          ...
          /*#__PURE__*/
          createElement(ScrollableWrap, null, _this.props.items))
        );
      };
...
var Dropdown = withDropdown(forwardRef(function (_ref4, ref) {
  ...
  return (
    ...
    createElement("div", Object.assign({
      className: cx(styles$R.wrap, className)
    }, props, {
      ref: ref
    }), children)
  );
...
var DropdownItem = function DropdownItem(_ref5) {
  ...
  return (
    ...
    createElement("div", Object.assign({}, props, {
      className: cx(textStyles.basic, styles$R.item(color), className)
    }))
  );
};
...
var DotIndicator = function DotIndicator(_ref) {
  ...
  return (
    ...
    React__default.createElement("span", {
      className: cx(styles$S.indicator, styles$S.state[state], styles$S.size.s, className)
    })
  );
};
...
var NonIdealState = function NonIdealState(_ref) {
  ...
  return (
    ...
    createElement(SVGImage, {
      glyph: image,
      className: cx(_defineProperty({}, styles$T.iconMargin, title || description))
    }) : null, Icon && !image ?
    /*#__PURE__*/
    createElement(Icon, {
      className: cx(styles$T.icon, _defineProperty({}, styles$T.iconMargin, title || description))
    }) : null, title &&
    /*#__PURE__*/
    createElement(Text, {
      variant: "h2",
      className: cx(styles$T.title, _defineProperty({}, styles$T.error, isError))
    }, title), description &&
    /*#__PURE__*/
    createElement(Text, {
...
var FlatListItem = function FlatListItem(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("li", {
      className: cx(styles$U.item, className)
    }, render(item))
  );
};
...
var FlatList = function FlatList(_ref2) {
  ...
  return (
    /*#__PURE__*/
    createElement("ul", {
      className: cx(styles$U.outer, className)
  ...
  horizontal: function horizontal(children, columns, itemClassName) {
    return children instanceof Array ? children.map(function (child) {
      return (
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$V.input, styles$V.columns[columns - 1], itemClassName)
        }, child)
      );
    }) :
    /*#__PURE__*/
  ...
  vertical: function vertical(children, columns, itemClassName) {
    ...
    return groupedItems.map(function (group) {
      return (
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$V.column, styles$V.columns[columns - 1])
        }, group.map(function (child) {
          return (
            /*#__PURE__*/
            createElement("div", {
              className: cx(styles$V.columnInput, itemClassName)
            }, child)
          );
        }))
      );
...
var HealthStatus = function HealthStatus(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement(Text, {
      className: cx(styles$X.status, className),
      variant: "p",
      tag: "div",
      title: title
    },
...
var styles$Y = {
  ...
  disabled:
  /*#__PURE__*/
  css$1("background-color:", colors.intentBaseBg, ";"),
  focused:
  /*#__PURE__*/
  css$1("border-color:rgba(0,0,0,0.26);box-shadow:0px 0px 3px rgba(0,0,0,0.24);"),
  error:
  /*#__PURE__*/
  css$1("border-color:", colors.intentDanger, ";box-shadow:0px 0px 3px ", rgba(colors.intentDanger, 0.65), ";"),
  outerWithAddition:
  /*#__PURE__*/
  css$1("display:flex;"),
  inputWithAddition:
  ...
  input:
  /*#__PURE__*/
  css$1("display:block;align-self:stretch;width:100%;min-width:0;height:100%;border:0;padding:5px 16px;box-sizing:border-box;border-radius:3px;font-family:", baseFontFamily, ";font-size:14px;line-height:22px;color:rgba(0,0,0,0.65);background-color:transparent;outline:none;"),
  inputWithIcon:
  /*#__PURE__*/
  css$1("padding:5px 8px 5px 16px;"),
  iconWrap:
  /*#__PURE__*/
  css$1("margin-right:7px;display:flex;align-items:center;"),
  withLeftElement:
  /*#__PURE__*/
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return (
        /*#__PURE__*/
        createElement("div", {
          className: cx$1(styles$Y.outer, (_cx = {}, _defineProperty(_cx, styles$Y.disabled, disabled), _defineProperty(_cx, styles$Y.focused, focused), _defineProperty(_cx, styles$Y.error, error), _defineProperty(_cx, styles$Y.outerWithAddition, hasAddition), _defineProperty(_cx, styles$Y.withLeftElement, !!leftElement), _defineProperty(_cx, styles$Y.withRightElement, !!rightElement), _cx), className),
          title: title
        }, leftElement,
        /*#__PURE__*/
        createElement("input", Object.assign({}, props, {
          ...
          className: cx$1(styles$Y.input, (_cx2 = {}, _defineProperty(_cx2, styles$Y.inputWithAddition, hasAddition), _defineProperty(_cx2, styles$Y.inputWithIcon, rightIcon || onClearClick), _cx2)),
          disabled: disabled,
          name: name,
          onChange: onChange,
          onKeyDown: onKeyDown,
...
var LabeledInput = function LabeledInput(_ref) {
  ...
  return (
    ...
    createElement(InputComponent, Object.assign({}, restProps, {
      error: error,
      className: cx(styles$_.input, inputClassName)
    })),
    /*#__PURE__*/
    createElement(Text, {
      variant: "p",
      className: cx(styles$_.message, _defineProperty({}, styles$_.errorMessage, error))
    }, message))
  );
};
...
var Link = function Link(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("a", {
      className: cx(styles$10.link, className),
      href: href,
      onClick: onClick,
      target: target,
      title: title
...
var styles$11 = {
  wrap:
  /*#__PURE__*/
  css("& code{padding:3px;border-radius:3px;background-color:", colors.codeBg, ";color:white;font-family:", monoFontFamily, ";}& pre{display:block;padding:16px;margin-bottom:16px;border-radius:4px;background-color:", colors.codeBg, ";color:white;& > code{padding:0;border-radius:0;background-color:transparent;}}"),
  h:
  /*#__PURE__*/
...
var NotificationSplash = function NotificationSplash(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("div", {
      className: cx(styles$12.splash, _defineProperty({}, styles$12.closePadding, onClose), className)
    },
    /*#__PURE__*/
    createElement(Text, {
    ...
    /*#__PURE__*/
    createElement(ControlsPanel, {
      className: cx(styles$12.controls, _defineProperty({}, styles$12.controlsMargin, children && controls)),
      controls: controls
    }), onClose &&
    /*#__PURE__*/
    createElement(IconClose, {
    ...
    value: function renderSplash() {
      ...
      return (
        ...
        createElement(NotificationSplash, {
          className: cx(styles$13.splash, className),
          controls: controls,
          onClose: onClose
        }, children)
      );
  ...
  _createClass(Spin, [{
    ...
    value: function render() {
      ...
      return (
        ...
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$14.container, {
            'blur': enable
          })
        }, children))
      );
    ...
    value: function renderSpin() {
      return (
        ...
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$14.rect, 'rect2')
        }),
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$14.rect, 'rect3')
        }),
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$14.rect, 'rect4')
        }),
        /*#__PURE__*/
        createElement("div", {
          className: cx(styles$14.rect, 'rect5')
        })))
      );
    }
  }]);
...
var PageCard = function PageCard(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("div", {
      className: cx$1(styles$15.container, // { [styles.corner]: showCorner },
      className)
    },
    /*#__PURE__*/
    createElement(Spin, {
...
var PageLayout = function PageLayout(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("div", {
      className: cx(styles$16.page, className)
    }, children)
  );
};
...
var PageSection = function PageSection(_ref) {
  ...
  return (
    ...
    createElement("section", {
      className: cx(styles$17.section, className)
    }, isHeadingPaneVisible &&
    /*#__PURE__*/
    createElement("div", {
      className: cx(styles$17.headingPane, _defineProperty({}, styles$17.headingPaneMargin, children))
    }, title &&
    /*#__PURE__*/
    createElement(Text, {
      ...
      return (
        ...
        createElement("div", null, visiblePages.map(function (visiblePage, index, array) {
          ...
          return (
            ...
            /*#__PURE__*/
            createElement(Button, {
              className: cx(styles$18.button, _defineProperty({}, styles$18.buttonActive, activePage === visiblePage)),
...
var PopupBody = function PopupBody(_ref) {
  ...
  /*#__PURE__*/
  createElement(Scrollbar, {
    className: cx(styles$19.scrollableWrap, className)
  },
  /*#__PURE__*/
  createElement("div", {
    className: cx(styles$19.scrollableBody, innerClassName)
  }, children)) :
  /*#__PURE__*/
  createElement("div", {
...
var RadioButton = function RadioButton(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("label", {
      className: cx(styles$1a.label, className),
      title: title
    },
    /*#__PURE__*/
    createElement("input", {
    ...
    /*#__PURE__*/
    createElement("div", {
      className: cx(styles$1a.iconWrap, _defineProperty({}, styles$1a.childrenMargin, children))
    },
    /*#__PURE__*/
      ...
      return (
        ...
        createElement("div", {
          ...
          return (
            /*#__PURE__*/
            createElement("button", {
              className: cx(styles$1d.tab, _defineProperty({}, styles$1d.activeTab, activeTab === i)),
              onClick: function onClick() {
...
var styles$1e = {
  ...
  codeRow:
  /*#__PURE__*/
  css("background-color:#FAFAFA;cursor:pointer;"),
  code:
  /*#__PURE__*/
...
function TableRow(_ref) {
  ...
  return (
    ...
    React__default.createElement("tr", Object.assign({
      ...
      className: cx(styles$1e.rowBackground, (_cx = {}, _defineProperty(_cx, styles$1e.row, !codeRow), _defineProperty(_cx, styles$1e.hoverRow, isHover), _cx))
    ...
    React__default.createElement("tr", {
      ...
      className: cx(styles$1e.codeRow, styles$1e.row, codeClassName, _defineProperty({}, styles$1e.hoverRow, isHover)),
      onClick: function onClick() {
...
var styles$1f = {
  ...
  baseIcon:
  /*#__PURE__*/
  css("width:6px;height:4px;fill:#000000a6;margin:1px;")
};
var IconSortableNone = function IconSortableNone(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("span", {
      className: cx(styles$1f.icon, className)
    },
    /*#__PURE__*/
    createElement(SVGImage, {
      className: cx(styles$1f.baseIcon),
      glyph: img$$
    }),
    /*#__PURE__*/
    createElement(SVGImage, {
...
var IconSortableAsc = function IconSortableAsc(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("span", {
      className: cx(styles$1g.icon, className)
    },
    /*#__PURE__*/
    createElement(SVGImage, {
      className: cx(styles$1g.baseIcon, styles$1g.styledIcon),
      glyph: img$$
    }),
    /*#__PURE__*/
    createElement(SVGImage, {
      className: cx(styles$1g.baseIcon),
      glyph: img$10
    }))
  );
};
...
var IconSortableDesc = function IconSortableDesc(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("span", {
      className: cx(styles$1h.icon, className)
    },
    /*#__PURE__*/
    createElement(SVGImage, {
      className: cx(styles$1h.baseIcon),
      glyph: img$$
    }),
    /*#__PURE__*/
    createElement(SVGImage, {
      className: cx(styles$1h.baseIcon, styles$1h.styledIcon),
      glyph: img$10
    }))
  );
};
...
var styles$1i = {
  ...
  head:
  /*#__PURE__*/
  css("color:#000000a6;font-weight:600;font-size:14px;padding:12px 16px;text-align:left;"),
  sortIcon:
  /*#__PURE__*/
        ...
        React__default.createElement("tr", headerGroup.getHeaderGroupProps(), headerGroup.headers.map(function (column) {
          return (
            ...
            React__default.createElement(IconSortable, {
              className: cx(styles$1i.sortIcon),
...
var Tag = function Tag(_ref) {
  ...
  return (
    ...
    createElement(Element, {
      className: cx((_cx = {}, _defineProperty(_cx, styles$1j.interactive(highlightingOnHover), !!highlightingOnHover), _defineProperty(_cx, styles$1j["static"], !highlightingOnHover), _defineProperty(_cx, styles$1j.pointer, onClick), _cx), styles$1j.tag, className),
      onClick: onClick,
      title: title
    }, text)
  );
...
var TagsList = function TagsList(_ref) {
  ...
  return (
    /*#__PURE__*/
    React__default.createElement("div", {
      className: cx(styles$1k.wrapper, className)
    }, heading &&
    /*#__PURE__*/
    React__default.createElement(Text, {
    ...
    React__default.createElement("div", null, (values || []).map(function (value) {
      return (
        ...
        React__default.createElement(Tag, {
          className: cx(styles$1k.tag, tagClassName),
          onClick: function onClick() {
...
var TiledListItem = function TiledListItem(_ref2) {
  ...
  return (
    /*#__PURE__*/
    createElement("li", {
      className: cx$1(styles$1l.item, _defineProperty({}, styles$1l.softCorners, corners === 'soft'), className)
    }, render(item))
  );
};
...
var TiledList = function TiledList(_ref3) {
  ...
  return (
    /*#__PURE__*/
    createElement("ul", {
      className: cx$1(styles$1l.outer({
        outer: outer
      }), className)
    }, items && items.map(function (item) {
      return (
...
var UriLabel = function UriLabel(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement("div", {
      className: cx(styles$1m.uriWrap, className),
      title: title
    },
    /*#__PURE__*/
    createElement(Icon, {
