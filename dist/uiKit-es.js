...
var styles$O = {
  wrap:
  /*#__PURE__*/
  css("& code{padding:3px;border-radius:3px;background-color:#eeeeee;}& pre{display:block;padding:16px;margin-top:21px;margin-bottom:21px;border-radius:4px;background-color:#f6f8fa;& > code{padding:0;border-radius:0;background-color:transparent;}}"),
  h1:
  /*#__PURE__*/
  css("margin-top:30px;margin-bottom:30px;"),
  h:
  /*#__PURE__*/
  css("margin-top:21px;margin-bottom:21px;"),
  p:
  /*#__PURE__*/
  css("margin-top:17px;margin-bottom:17px;")
};
var overrides = {
  h1: function h1(_ref) {
    var children = _ref.children,
...
var NotificationSplash = function NotificationSplash(_ref) {
  ...
  return createElement("div", {
    className: cx(styles$P.splash, _defineProperty({}, styles$P.closePadding, onClose), className)
  }, createElement(Text, {
    className: styles$P.children,
    tag: "span"
  }, children), createElement(ControlsPanel, {
    className: cx(styles$P.controls, _defineProperty({}, styles$P.controlsMargin, children && controls)),
    controls: controls
  ...
  _createClass(NotificationSplashFixed, [{
    ...
    value: function renderSplash() {
      ...
      return createElement(NotificationSplash, {
        className: cx(styles$Q.splash, className),
        controls: controls,
        onClose: onClose
      }, children);
    }
  ...
  _createClass(Spin, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        ...
        className: cx(styles$R.container, {
          'blur': enable
        })
      }, children));
    }
    ...
    value: function renderSpin() {
      return createElement("div", {
        ...
        className: cx(styles$R.rect, 'rect2')
      }), createElement("div", {
        className: cx(styles$R.rect, 'rect3')
      }), createElement("div", {
        className: cx(styles$R.rect, 'rect4')
      }), createElement("div", {
        className: cx(styles$R.rect, 'rect5')
      })));
    }
  }]);
...
var PageCard = function PageCard(_ref) {
  ...
  return createElement("div", {
    className: cx$1(styles$S.container, // { [styles.corner]: showCorner },
    className)
  }, createElement(Spin, {
    enable: loading
  }, createElement(Text, {
...
var PageLayout = function PageLayout(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return createElement("div", {
    className: cx(styles$T.page, className)
  }, children);
};
...
var PageSection = function PageSection(_ref) {
  ...
  return createElement("section", {
    className: cx(styles$U.section, className)
  }, isHeadingPaneVisible && createElement("div", {
    className: cx(styles$U.headingPane, _defineProperty({}, styles$U.headingPaneMargin, children))
...
var PopupBody = function PopupBody(_ref) {
  ...
  return scrollable ? createElement(Scrollbar, {
    className: cx(styles$V.scrollableWrap, className)
  }, createElement("div", {
    className: cx(styles$V.scrollableBody, innerClassName)
  }, children)) : createElement("div", {
