...
var textStyles = {
  h1: /*#__PURE__*/css("margin:0;font-family:", baseFontFamily, ";font-size:24px;line-height:40px;font-weight:600;color:", colors.baseHeading, ";-webkit-font-smoothing:antialiased;"),
  h2: /*#__PURE__*/css("margin:0;font-family:", baseFontFamily, ";font-size:20px;line-height:28px;font-weight:600;color:", colors.baseHeading, ";-webkit-font-smoothing:antialiased;"),
  h3: /*#__PURE__*/css("margin:0;font-family:", baseFontFamily, ";font-size:16px;line-height:24px;font-weight:600;color:", colors.baseHeading, ";-webkit-font-smoothing:antialiased;"),
  h4: /*#__PURE__*/css("margin:0;font-family:", baseFontFamily, ";font-size:14px;line-height:22px;font-weight:600;color:", colors.baseHeading, ";-webkit-font-smoothing:antialiased;"),
  h5: /*#__PURE__*/css("margin:0;font-family:", baseFontFamily, ";font-size:12px;line-height:22px;text-transform:uppercase;letter-spacing:0.01em;color:", colors.baseHeading, ";font-weight:600;-webkit-font-smoothing:antialiased;"),
  ...
  code: /*#__PURE__*/css("margin:0;font-family:", monoFontFamily, ";font-size:14px;line-height:22px;color:#000000;-webkit-font-smoothing:antialiased;b{font-weight:600;}"),
...
var styles$8 = /*#__PURE__*/css("width:64px;height:41px;");
...
var styles$9 = /*#__PURE__*/css("fill:", colors.dark65, ";");
...
var styles$a = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$b = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentDanger, ";");
...
var styles$c = /*#__PURE__*/css("width:16px;height:16px;fill:rgba(0,0,0,.65);");
...
var styles$d = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentPrimary, ";");
...
var styles$f = /*#__PURE__*/css("width:16px;height:16px;fill:rgba(0,0,0,.65);");
...
var styles$g = /*#__PURE__*/css("width:16px;height:16px;fill:#000;");
...
var styles$h = /*#__PURE__*/css("width:14px;height:14px;fill:#fff;");
...
var styles$i = /*#__PURE__*/css("fill:#fff;");
...
var styles$j = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary65, ";");
...
var styles$k = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary65, ";");
...
var styles$l = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentDanger65, ";");
...
var styles$m = /*#__PURE__*/css("width:36px;height:36px;");
...
var styles$n = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$o = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary65, ";");
...
var styles$q = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$r = /*#__PURE__*/css("fill:", colors.dark65, ";");
...
var styles$s = /*#__PURE__*/css("fill:", colors.dark65, ";");
...
var styles$t = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary, ";");
...
var styles$u = /*#__PURE__*/css("width:14px;height:14px;fill:", colors.intentDanger, ";");
...
var styles$v = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$w = /*#__PURE__*/css("width:14px;height:14px;fill:", colors.dark65, ";");
...
var styles$y = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentPrimary65, ";");
...
var styles$z = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary65, ";");
...
var styles$A = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentSuccess, ";");
...
var styles$B = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentPrimary, ";stroke:", colors.intentPrimary, ";");
...
var styles$C = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary45, ";");
...
var styles$D = /*#__PURE__*/css("fill:#fff;");
...
var styles$E = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark25, ";");
...
var styles$G = /*#__PURE__*/css("width:16px;height:16px;");
...
var styles$H = /*#__PURE__*/css("width:24px;height:24px;");
...
var styles$J = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentSuccess, ";");
...
var styles$K = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentDanger, ";");
...
var styles$L = /*#__PURE__*/css("width:16px;height:16px;");
...
var styles$N = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentPrimary, ";");
...
var styles$O = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentWarning, ";");
...
var styles$P = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentPrimary, ";");
...
var ScrollWrapper = /*#__PURE__*/styled("div", {
  target: "e1gokkyi0"
})("height:100%;");
...
var Scrollbar = function Scrollbar(_ref3) {
  var children = _ref3.children,
      ...
      track = _ref3.track,
      thumb = _ref3.thumb;
  return /*#__PURE__*/createElement(ScrollWrapper, {
    className: className
  }, /*#__PURE__*/createElement(ReactScroll, {
    track: track,
    thumb: thumb,
...
var styles$V = {
  link: /*#__PURE__*/css("color:", rgba(colors.intentPrimary, 0.65), ";text-decoration:none;&:hover,&:focus{color:", colors.intentPrimary, ";}&:active{color:", colors.activeAction, ";}")
};
...
var styles$Z = {
  header: /*#__PURE__*/css$1("height:68px;background:#ffffff;width:100%;display:flex;padding:0 30px;box-sizing:border-box;flex-direction:row;justify-content:space-between;align-items:center;"),
...
var styles$$ = {
  ...
  shim: /*#__PURE__*/css("position:fixed;z-index:", zIndex.modal, ";left:0;right:0;top:0;bottom:0;display:flex;flex-direction:column;padding:40px 16px;overflow:auto;background-color:", rgba(colors.dark, 0.15), ";justify-content:flex-start;align-items:center;"),
...
var styles$10 = {
  ...
  input: /*#__PURE__*/css("position:absolute;clip:rect(0 0 0 0);width:1px;height:1px;margin:-1px;& + div::before{content:'';position:absolute;top:-2px;left:-2px;right:-2px;bottom:-2px;border:solid 1px rgba(255,255,255,0);border-radius:3px;}&:focus + div::before{border-color:", rgba(colors.intentPrimary, 0.55), ";}"),
...
var styles$12 = {
  ...
  closeIcon: /*#__PURE__*/css("position:absolute;top:30px;right:30px;fill:", colors.dark40, ";"),
...
var styles$13 = {
  ...
  cornerUp: /*#__PURE__*/css("&::after{top:-", CORNER_HEIGHT, "px;bottom:auto;border:solid 0 transparent;border-left:solid ", CORNER_HEIGHT, "px transparent;border-right:solid ", CORNER_HEIGHT, "px transparent;border-bottom:solid ", CORNER_HEIGHT, "px rgba(0,0,0,0.65);}"),
...
var commonInputStyles = {
  ...
  disabled: /*#__PURE__*/css$1("background-color:", colors.dark2, ";"),
...
var overrides = {
  ...
  code: function code(_ref9) {
    ...
    return className && className.indexOf('lang-') === 0 ? /*#__PURE__*/createElement(CodeBlock, {
...
var styles$1i = {
  page: /*#__PURE__*/css("display:flex;flex-direction:column;max-width:1420px;min-width:922px;padding:0 30px;margin:30px auto 30px;"),
  ...
  headingPanel: /*#__PURE__*/css("display:flex;justify-content:flex-end;align-items:baseline;margin-bottom:15px;"),
...
var styles$1k = {
  ...
  countItemsText: /*#__PURE__*/css("display:flex;align-items:center;margin-right:12px;color:rgba(0,0,0,0.65);"),
  icon: /*#__PURE__*/css("width:16px;height:16px;margin:8px 8px;fill:rgba(0,0,0,.65);"),
  chevronIcon: /*#__PURE__*/css("fill:rgba(0,0,0,.65);"),
  button: /*#__PURE__*/css("min-width:32px;height:32px;background:#FFFFFF;border:1px solid #D9D9D9;box-sizing:border-box;border-radius:4px;color:rgba(0,0,0,0.65);font-size:14px;text-align:center;padding:4px;margin:0 4px;"),
  buttonActive: /*#__PURE__*/css("color:#CF1322;border:1px solid #CF1322;"),
  dropDown: /*#__PURE__*/css("margin-left:12px;min-width:120px;")
};

var IconChevronRightBlack = function IconChevronRightBlack() {
  return /*#__PURE__*/createElement(IconChevronRight, {
    className: styles$1k.chevronIcon
  });
};

var IconChevronLeftBlack = function IconChevronLeftBlack() {
  return /*#__PURE__*/createElement(IconChevronLeft, {
    className: styles$1k.chevronIcon
  });
};

var IconChevronDownBlack = function IconChevronDownBlack() {
  return /*#__PURE__*/createElement(IconChevronDown, {
    className: styles$1k.chevronIcon
  });
};
    ...
    value: function render() {
      ...
      return /*#__PURE__*/createElement("div", {
        ...
        return /*#__PURE__*/createElement(Fragment, {
          key: visiblePage
        }, needElipsis && /*#__PURE__*/createElement(IconMore, {
...
var styles$1l = {
  pagination: /*#__PURE__*/css("display:flex;"),
  icon: /*#__PURE__*/css("width:32px;height:32px;margin:0 4px;fill:rgba(0,0,0,.65);"),
  chevronIcon: /*#__PURE__*/css("fill:rgba(0,0,0,.65);"),
  button: /*#__PURE__*/css("display:block;min-width:32px;height:32px;background:#FFFFFF;border:1px solid #D9D9D9;box-sizing:border-box;border-radius:4px;color:rgba(0,0,0,0.65);font-size:14px;text-align:center;padding:4px;margin:0 4px;"),
  activePage: /*#__PURE__*/css("min-width:32px;height:32px;box-sizing:border-box;color:rgba(0,0,0,0.65);padding:4px;margin:0 4px;display:flex;align-items:center;justify-content:center;"),
  dropDown: /*#__PURE__*/css("margin-left:12px;min-width:120px;")
};
...
var styles$1n = {
  ...
  children: /*#__PURE__*/css("overflow:hidden;text-overflow:ellipsis;white-space:nowrap;"),
  childrenMargin: /*#__PURE__*/css("margin-right:8px;"),
  input: /*#__PURE__*/css("position:absolute;clip:rect(0 0 0 0);width:1px;height:1px;margin:-1px;& + div::before{content:'';position:absolute;top:-2px;left:-2px;right:-2px;bottom:-2px;border:solid 1px rgba(255,255,255,0);border-radius:50%;}&:focus + div::before{border-color:", rgba(colors.intentPrimary, 0.55), ";}"),
  label: /*#__PURE__*/css("display:flex;align-items:center;cursor:pointer;")
};
...
var styles$1p = {
  container: /*#__PURE__*/css$1("border-top:none;overflow:hidden;width:256px;background:", colors.baseHeading, ";height:100%;padding:0;display:flex;flex-direction:column;user-select:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;"),
...
var styles$1q = {
  ...
  logoContainer: /*#__PURE__*/css("width:68px;flex-grow:0;flex-shrink:0;background:", colors.baseHeading, ";display:flex;flex-direction:column;justify-content:center;position:relative;"),
...
var styles$1r = {
  input: /*#__PURE__*/css("position:absolute;clip:rect(0 0 0 0);width:1px;height:1px;margin:-1px;&:focus + div::before{content:'';position:absolute;top:-3px;left:-3px;right:-3px;bottom:-3px;border:solid 1px rgba(255,255,255,0);border-radius:15px;}&:focus + div::before{border-color:", rgba(colors.intentPrimary, 0.55), ";}"),
...
var styles$1s = {
  ...
  activeTab: /*#__PURE__*/css("color:", colors.baseHeading, ";border-bottom-color:", colors.baseHeading, ";"),
...
var styles$1t = {
  ...
  rowBackground: /*#__PURE__*/css("background-color:#FFFFFF;"),
  row: /*#__PURE__*/css("box-shadow:inset 0px -1px 0px rgba(0,0,0,0.1);"),
  codeRow: /*#__PURE__*/css("background-color:#FAFAFA;"),
  code: /*#__PURE__*/css("position:relative;padding:8px 48px 8px 16px;white-space:pre-wrap;"),
  hoverRow: /*#__PURE__*/css("background-color:#EFEFEF;"),
  pointer: /*#__PURE__*/css("cursor:pointer;"),
  moreIcon: /*#__PURE__*/css("position:absolute;right:18px;top:50%;transform:translate(0,-50%);")
};
...
function TableRow(_ref) {
  ...
  }, get2RowFromStr(codeRow), /*#__PURE__*/React.createElement(IconMoreBurger, {
    className: styles$1t.moreIcon
  }))));
}

var styles$1u = {
  table: /*#__PURE__*/css("background-color:transparent;width:100%;border-spacing:initial;"),
...
function Table(props) {
  ...
  }), /*#__PURE__*/createElement("thead", null, headerGroups.map(function (headerGroup) {
  ...
  })), /*#__PURE__*/createElement("tbody", getTableBodyProps(), dataRows.map(function (row) {
    prepareRow(row);
