...
var IconCheckbox = function IconCheckbox(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement(Icon, {
      className: cx(styles$a, _defineProperty({}, stylesDisabled, disabled), className),
      glyph: states[mask]
    })
  );
};
...
var IconRadio = function IconRadio(_ref) {
  ...
  return (
    /*#__PURE__*/
    createElement(Icon, {
      className: cx(styles$w, _defineProperty({}, stylesDisabled$1, disabled), className),
      glyph: states$1[mask]
    })
  );
};
...
var Button = forwardRef(function (_ref, ref) {
  ...
  if (IconRight && !isOnlyIcon) {
    ...
    createElement(IconRight, {
      className: cx$1(styles$D.icon, styles$D.iconRightMargin)
    }));
  }
...
var styles$J = {
  ...
  popover:
  /*#__PURE__*/
  css("position:absolute;left:0;padding:8px 0;border-radius:4px;margin:0;box-shadow:0 5px 20px 0 rgba(0,0,0,0.09);border:solid 1px ", colors.intentBaseBg, ";background-color:#ffffff;z-index:", zIndex.dropdownMenu, ";box-sizing:border-box;user-select:none;list-style:none;"),
  item: function item() {
    var color = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultListItemColor;
    return (
      /*#__PURE__*/
      css("padding:0 16px;line-height:32px;white-space:nowrap;color:", color, ";&:hover{cursor:pointer;background-color:", colors.intentBaseActive, ";}")
    );
  },
  divider:
  /*#__PURE__*/
...
var withDropdown = function withDropdown(Component$1) {
  var _temp;
    ...
    function Dropdown() {
      ...
      _this.renderPopover = function () {
        ...
        return (
          /*#__PURE__*/
          createElement("ul", {
            className: cx(styles$J.popover, popoverClassName),
...
var Dropdown = withDropdown(forwardRef(function (_ref2, ref) {
...
var DropdownDivider = function DropdownDivider(_ref4) {
  ...
  return (
    /*#__PURE__*/
    createElement("li", {
      className: cx(styles$J.divider, className),
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return (
        /*#__PURE__*/
        createElement("div", {
          className: cx$1(styles$Q.outer, (_cx = {}, _defineProperty(_cx, styles$Q.disabled, disabled), _defineProperty(_cx, styles$Q.focused, focused), _defineProperty(_cx, styles$Q.error, error), _defineProperty(_cx, styles$Q.outerWithAddition, hasAddition), _defineProperty(_cx, styles$Q.withLeftElement, !!leftElement), _defineProperty(_cx, styles$Q.withRightElement, !!rightElement), _cx), className),
          title: title
        }, leftElement,
        /*#__PURE__*/
        createElement("input", Object.assign({}, props, {
          ...
          className: cx$1(styles$Q.input, (_cx2 = {}, _defineProperty(_cx2, styles$Q.inputWithAddition, hasAddition), _defineProperty(_cx2, styles$Q.inputWithIcon, rightIcon || onClearClick), _cx2)),
          disabled: disabled,
          name: name,
          onChange: onChange,
          onKeyDown: onKeyDown,
