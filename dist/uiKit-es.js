...
var styles$j = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$m = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentDanger65, ";");
...
var styles$n = /*#__PURE__*/css("width:36px;height:36px;");
...
var styles$o = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$p = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary65, ";");
...
var styles$u = /*#__PURE__*/css("width:12px;height:12px;fill:", colors.intentPrimary, ";");
...
var styles$v = /*#__PURE__*/css("width:14px;height:14px;fill:", colors.intentDanger, ";");
...
var styles$w = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$x = /*#__PURE__*/css("width:14px;height:14px;fill:", colors.dark65, ";");
...
var styles$y = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.dark65, ";");
...
var styles$z = /*#__PURE__*/css("width:16px;height:16px;fill:", colors.intentPrimary65, ";");
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return /*#__PURE__*/createElement(Fragment, null, /*#__PURE__*/createElement(Component$1, Object.assign({}, props, {
          className: cx(styles$11.wrapper, className),
      ...
      value: function renderTooltip() {
        ...
        return /*#__PURE__*/createElement("div", {
          className: cx(textStyles.p, styles$11.tooltip({
            cornerPositionX: cornerPositionX
...
var styles$12 = {
  block: /*#__PURE__*/css("padding:20px;border-radius:10px;background-color:", colors.dark, ";color:white;"),
...
var Icon$1 = function Icon(_ref) {
  ...
  return /*#__PURE__*/createElement(IconCopy, Object.assign({
    className: cx(className, styles$12.copyIcon)
  }, props));
};
...
var CodeBlockWrap = function CodeBlockWrap(_ref2) {
  ...
  return /*#__PURE__*/createElement("pre", {
    className: cx(styles$12.block, _defineProperty({}, styles$12.withBtn, !!textToCopy), className)
...
var PopupFooter = function PopupFooter(_ref) {
  ...
  return /*#__PURE__*/createElement("div", {
    ...
    className: cx(styles$13.controls),
    controls: controls,
    thin: true
  }));
};
  ...
  _createClass(Modal, [{
    ...
    value: function renderModal() {
      ...
      return /*#__PURE__*/createElement("div", {
        ...
        className: cx(styles$$.baseModal, styles$14.modal, (_cx = {}, _defineProperty(_cx, styles$14.fit, fit), _defineProperty(_cx, styles$$.wide, wide), _cx), className),
        ref: this.modalRef,
        tabIndex: 0,
        onKeyDown: this.handleEscapePress,
        onSubmit: onSubmit
        ...
        className: cx(styles$14.children, _defineProperty({}, styles$14.childrenThin, thinBorders))
...
var DotIndicator = function DotIndicator(_ref) {
  ...
  return /*#__PURE__*/React.createElement("span", {
    className: cx(styles$15.indicator, styles$15.state[state], styles$15.size.s, className)
  });
};
...
var NonIdealState = function NonIdealState(_ref) {
  ...
  return /*#__PURE__*/createElement("div", {
    className: cx(styles$16.wrap, className)
  }, image ? /*#__PURE__*/createElement(SVGImage, {
    glyph: image,
    className: cx(_defineProperty({}, styles$16.iconMargin, title || description))
  }) : null, Icon && !image ? /*#__PURE__*/createElement(Icon, {
    className: cx(styles$16.icon, _defineProperty({}, styles$16.iconMargin, title || description))
  }) : null, title && /*#__PURE__*/createElement(Text, {
    variant: "h2",
    className: cx(styles$16.title, _defineProperty({}, styles$16.error, isError))
...
var FlatListItem = function FlatListItem(_ref) {
  ...
  return /*#__PURE__*/createElement("li", {
    className: cx(styles$17.item, className)
  }, render(item));
};
...
var FlatList = function FlatList(_ref2) {
  ...
  return /*#__PURE__*/createElement("ul", {
    className: cx(styles$17.outer, className)
...
var renderers = {
  horizontal: function horizontal(children, columns, itemClassName) {
    return children instanceof Array ? children.map(function (child) {
      return /*#__PURE__*/createElement("div", {
        className: cx(styles$18.input, styles$18.columns[columns - 1], itemClassName)
      }, child);
    }) : /*#__PURE__*/createElement("div", {
      className: cx(styles$18.input, styles$18.columns[columns - 1], itemClassName)
    }, children);
  ...
  vertical: function vertical(children, columns, itemClassName) {
    ...
    return groupedItems.map(function (group) {
      return /*#__PURE__*/createElement("div", {
        className: cx(styles$18.column, styles$18.columns[columns - 1])
      }, group.map(function (child) {
        return /*#__PURE__*/createElement("div", {
          className: cx(styles$18.columnInput, itemClassName)
        }, child);
      }));
    });
  }
...
var styles$1e = {
  wrap: /*#__PURE__*/css("display:block;& code{padding:3px;border-radius:3px;background-color:", colors.codeBg, ";color:white;font-family:", monoFontFamily, ";}"),
...
var styles$1j = {
  page: /*#__PURE__*/css("display:flex;flex-direction:column;max-width:", pageLayoutMaxWidth, "px;min-width:", pageLayoutMinWidth, "px;min-height:calc(100% - ", appLayoutTopPanelHeight, "px - 60px);padding:0 30px;margin:30px auto 30px;box-sizing:border-box;"),
...
var PageLayout = function PageLayout(_ref) {
  ...
  var children = _ref.children,
      ...
      wide = _ref.wide;
  return /*#__PURE__*/createElement("div", {
    className: cx(styles$1j.page, (_cx = {}, _defineProperty(_cx, styles$1j.wide, wide), _defineProperty(_cx, styles$1j.pageWithAbovePanel, !!AboveComponent), _cx), className)
    ...
    className: cx(_defineProperty({}, styles$1j.divider, !topLeftControls)),
    variant: "h1"
  }, heading), topLeftControls && /*#__PURE__*/createElement(ControlsPanel, {
    className: cx(styles$1j.leftControls, styles$1j.divider),
    ...
    value: function render() {
      ...
      return /*#__PURE__*/createElement("div", {
        ...
        return /*#__PURE__*/createElement("button", {
          className: cx(textStyles.h3, styles$1t.tab, _defineProperty({}, styles$1t.activeTab, activeTab === i)),
          onClick: function onClick() {
...
function TableRow(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("tr", Object.assign({
    ...
    className: cx((_cx = {}, _defineProperty(_cx, styles$1u.row, !codeRow), _defineProperty(_cx, styles$1u.hoverRow, isHover), _defineProperty(_cx, styles$1u.pointer, onRowClick), _cx))
    ...
    className: cx(styles$1u.row, codeClassName, (_cx2 = {}, _defineProperty(_cx2, styles$1u.hoverRow, isHover), _defineProperty(_cx2, styles$1u.pointer, onCodeRowClick), _cx2)),
    onClick: function onClick() {
...
var UploadZone = function UploadZone(_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: cx(styles$1z.wrap, className),
    ref: ref
...
var UriLabel = function UriLabel(_ref) {
  ...
  return /*#__PURE__*/createElement("div", {
    className: cx(styles$1A.uriWrap, className),
    title: title
  }, /*#__PURE__*/createElement(Icon, {
