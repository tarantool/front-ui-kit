import React__default, { createElement, createRef, Component, forwardRef, Fragment } from 'react';
  ...
  function (_React$Component) {
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return createElement(Fragment, null, createElement(Component$1, Object.assign({}, props, {
...
function (_React$Component) {
  ...
  _createClass(CopyToClipboard, [{
    ...
    value: function render() {
      ...
      return createElement(ButtonWithTooltip, Object.assign({
...
var DropdownItem = function DropdownItem(_ref2) {
  ...
  return createElement("li", Object.assign({}, props, {
...
var NonIdealState = function NonIdealState(_ref) {
  ...
  })) : null, Icon && !image ? createElement(Icon, {
    className: cx(styles$L.icon, _defineProperty({}, styles$L.iconMargin, title || description))
  }) : null, title && createElement(Text, {
    variant: "h2",
...
var NonIdealStateAction = function NonIdealStateAction(_ref2) {
  var actionText = _ref2.actionText,
      ...
      title = _ref2.title;
  return createElement(NonIdealState, {
    className: className,
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        ...
        readOnly: readOnly,
        ref: this.elementRef
      }, props)), (onClearClick || rightIcon) && createElement("div", {
...
function (_React$Component) {
  ...
  _createClass(InputPassword, [{
    ...
    value: function render() {
      ...
      return createElement(Input, Object.assign({}, this.props, {
        type: hidden ? 'password' : 'text',
        rightIcon: createElement(Button, {
...
var LeaderFlagSmall = function LeaderFlagSmall(_ref) {
  ...
  return createElement("svg", {
    ...
    className: cx(styles$U.flag, className)
  }, createElement("use", {
...
var Link = function Link(_ref) {
  ...
  return createElement("a", {
    className: cx(styles$V.link, className),
    href: href,
    onClick: onClick,
    target: target,
    title: title
...
var overrides = {
  h1: function h1(_ref) {
    ...
    return createElement(Text, Object.assign({}, props, {
  ...
  a: function a(_ref8) {
    ...
    return createElement(Link, Object.assign({}, props, {
      target: "_blank"
    }), children);
  },
  code: function code(_ref9) {
    ...
    return className && className.indexOf('lang-') === 0 ? createElement(CodeBlock, {
...
var NotificationSplash = function NotificationSplash(_ref) {
  ...
  return createElement("div", {
    className: cx(styles$X.splash, _defineProperty({}, styles$X.closePadding, onClose), className)
  }, createElement(Text, {
    className: styles$X.children,
    tag: "span"
  }, children), createElement(ControlsPanel, {
    className: cx(styles$X.controls, _defineProperty({}, styles$X.controlsMargin, children && controls)),
    controls: controls
  ...
  _createClass(NotificationSplashFixed, [{
    ...
    value: function renderSplash() {
      var _this$props = this.props,
          ...
          onClose = _this$props.onClose;
      return createElement(NotificationSplash, {
        className: cx(styles$Y.splash, className),
        controls: controls,
        onClose: onClose
      }, children);
    }
  ...
  _createClass(Spin, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        ...
        className: cx(styles$Z.container, {
          'blur': enable
        })
      }, children));
    }
    ...
    value: function renderSpin() {
      return createElement("div", {
        ...
        className: cx(styles$Z.rect, 'rect2')
      }), createElement("div", {
        className: cx(styles$Z.rect, 'rect3')
      }), createElement("div", {
        className: cx(styles$Z.rect, 'rect4')
      }), createElement("div", {
        className: cx(styles$Z.rect, 'rect5')
      })));
    }
  }]);
...
var PageCard = function PageCard(_ref) {
  ...
  return createElement("div", {
    className: cx$1(styles$_.container, // { [styles.corner]: showCorner },
    className)
  }, createElement(Spin, {
    enable: loading
  }, createElement(Text, {
...
var PageSection = function PageSection(_ref) {
  ...
  return createElement("section", {
    className: cx(styles$10.section, className)
  }, isHeadingPaneVisible && createElement("div", {
    className: cx(styles$10.headingPane, _defineProperty({}, styles$10.headingPaneMargin, children))
...
var PopupBody = function PopupBody(_ref) {
  ...
  return scrollable ? createElement(Scrollbar, {
    className: cx(styles$11.scrollableWrap, className)
  }, createElement("div", {
    className: cx(styles$11.scrollableBody, innerClassName)
  }, children)) : createElement("div", {
...
var SplashModal = function SplashModal(_ref) {
  ...
  return createElement(BaseModal, Object.assign({
    className: cx(styles$13.modal, className),
    shimClassName: cx(styles$13.shim, shimClassName)
    ...
    variant: 'h1'
  }, title), subTitle && createElement("div", {
...
var Switcher = function Switcher(_ref) {
  ...
  var checked = _ref.checked,
      ...
      title = _ref.title;
  return createElement("label", {
    className: cx(styles$14.label, className),
    title: title
  }, createElement("input", {
    checked: checked,
    ...
    value: function render() {
      ...
      return createElement("div", {
        ...
        return createElement("button", {
          className: cx(styles$15.tab, _defineProperty({}, styles$15.activeTab, activeTab === i)),
          onClick: function onClick() {
...
var Tag = function Tag(_ref) {
  ...
  return createElement(Element, {
    className: cx((_cx = {}, _defineProperty(_cx, styles$16.interactive(highlightingOnHover), !!highlightingOnHover), _defineProperty(_cx, styles$16["static"], !highlightingOnHover), _defineProperty(_cx, styles$16.pointer, onClick), _cx), styles$16.tag, className),
    onClick: onClick,
    title: title
  }, text);
};
...
var TagsList = function TagsList(_ref) {
  var className = _ref.className,
      ...
      values = _ref.values;
  return React__default.createElement("div", {
    className: cx(styles$17.wrapper, className)
    ...
    return React__default.createElement(Tag, {
      className: cx(styles$17.tag, tagClassName),
      onClick: function onClick() {
...
var TiledListItem = function TiledListItem(_ref2) {
  var className = _ref2.className,
      ...
      render = _ref2.render;
  return createElement("li", {
    className: cx$1(styles$18.item, _defineProperty({}, styles$18.softCorners, corners === 'soft'), className)
  }, render(item));
};
...
var TiledList = function TiledList(_ref3) {
  ...
  return createElement("ul", {
    className: cx$1(styles$18.outer({
      outer: outer
    }), className)
  }, items && items.map(function (item) {
...
var UriLabel = function UriLabel(_ref) {
  ...
  return createElement("div", {
    className: cx(styles$19.uriWrap, className),
    title: title
  }, createElement(Icon, {
