  ...
  _createClass(PaginationControlled, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/createElement("div", {
        ...
        className: cx(styles$1m.btn, styles$1m.buttonArrow),
        onClick: this.changePage(activePage - 1),
        disabled: activePage === 1,
        icon: IconChevronLeft,
        intent: "plain"
      }), /*#__PURE__*/createElement(Text, {
        className: cx(styles$1m.btn, styles$1m.activePage)
...
function Table(props) {
  ...
  }), rows.length > 0 && /*#__PURE__*/createElement("thead", null, headerGroups.map(function (headerGroup) {
