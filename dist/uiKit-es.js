...
var HealthStatus = function HealthStatus(_ref) {
  ...
  return createElement(Text, {
    className: cx(styles$D.status, className),
    variant: "p",
    tag: "div"
...
function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        className: cx$1(styles$E.outer, (_cx = {}, _defineProperty(_cx, styles$E.disabled, disabled), _defineProperty(_cx, styles$E.focused, focused), _defineProperty(_cx, styles$E.error, error), _cx), className)
      }, createElement("input", {
        autoFocus: autoFocus,
        autoComplete: autoComplete,
        className: cx$1(styles$E.input, _defineProperty({}, styles$E.inputWithIcon, rightIcon || onClearClick)),
        disabled: disabled,
        name: name,
        onChange: onChange,
...
var LeaderFlagSmall = function LeaderFlagSmall(_ref) {
  ...
  return createElement("svg", {
    ...
    className: cx(styles$H.flag, className)
  }, createElement("use", {
...
var NotificationSplash = function NotificationSplash(_ref) {
  ...
  return createElement("div", {
    className: cx(styles$I.splash, _defineProperty({}, styles$I.closePadding, onClose), className)
  }, createElement(Text, {
    className: styles$I.children,
    tag: "span"
  }, children), createElement(ControlsPanel, {
    className: cx(styles$I.controls, _defineProperty({}, styles$I.controlsMargin, children && controls)),
    controls: controls
  ...
  _createClass(Spin, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        ...
        className: cx(styles$J.container, {
          'blur': enable
        })
      }, children));
    }
    ...
    value: function renderSpin() {
      return createElement("div", {
        ...
        className: cx(styles$J.rect, 'rect2')
      }), createElement("div", {
        className: cx(styles$J.rect, 'rect3')
      }), createElement("div", {
        className: cx(styles$J.rect, 'rect4')
      }), createElement("div", {
        className: cx(styles$J.rect, 'rect5')
      })));
    }
  }]);
...
var PageCard = function PageCard(_ref) {
  ...
  return createElement("div", {
    className: cx$1(styles$K.container, // { [styles.corner]: showCorner },
    className)
  }, createElement(Spin, {
    enable: loading
  }, createElement(Text, {
...
var PageLayout = function PageLayout(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return createElement("div", {
    className: cx(styles$L.page, className)
  }, children);
};
...
var PageSection = function PageSection(_ref) {
  ...
  return createElement("section", {
    className: cx(styles$M.section, className)
  }, isHeadingPaneVisible && createElement("div", {
    className: cx(styles$M.headingPane, _defineProperty({}, styles$M.headingPaneMargin, children))
...
var PopupBody = function PopupBody(_ref) {
  ...
  return scrollable ? createElement(Scrollbar, {
    className: cx(styles$N.scrollableWrap, className)
  }, createElement("div", {
    className: cx(styles$N.scrollableBody, innerClassName)
  }, children)) : createElement("div", {
...
var Switcher = function Switcher(_ref) {
  ...
  var checked = _ref.checked,
      ...
      onChange = _ref.onChange;
  return createElement("label", {
    className: cx(styles$P.label, className)
  }, createElement("input", {
    checked: checked,
    ...
    className: cx(styles$P.switcher, (_cx = {}, _defineProperty(_cx, styles$P.notDisabled, !checked && !disabled), _defineProperty(_cx, styles$P.checked, checked && !disabled), _defineProperty(_cx, styles$P.disabled, !checked && disabled), _defineProperty(_cx, styles$P.basicDisabled, disabled), _defineProperty(_cx, styles$P.checkedDisabled, checked && disabled), _defineProperty(_cx, styles$P.childrenMargin, children), _cx))
  }), typeof children === 'string' ? createElement(Text, {
  ...
  _createClass(Tabbed, [{
    ...
    value: function render() {
      ...
      return createElement("div", {
        ...
        return createElement("button", {
          className: cx(styles$Q.tab, _defineProperty({}, styles$Q.activeTab, activeTab === i)),
...
var Tag = function Tag(_ref) {
  ...
  return createElement(Element, {
    className: cx((_cx = {}, _defineProperty(_cx, styles$R.interactive(highlightingOnHover), !!highlightingOnHover), _defineProperty(_cx, styles$R["static"], !highlightingOnHover), _defineProperty(_cx, styles$R.pointer, onClick), _cx), styles$R.tag, className),
    onClick: onClick
  }, text);
};
...
var TagsList = function TagsList(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    return React__default.createElement(Tag, {
      className: cx(styles$S.tag, tagClassName),
      onClick: function onClick() {
...
var TiledListItem = function TiledListItem(_ref2) {
  var className = _ref2.className,
      ...
      render = _ref2.render;
  return createElement("li", {
    className: cx$1(styles$T.item, _defineProperty({}, styles$T.softCorners, corners === 'soft'), className)
  }, render(item));
};
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      return createElement(Component, {
        className: cx(styles$U.wrapper, className),
    ...
    value: function renderTooltip() {
      ...
      return createElement("div", {
        className: cx(textStyles.p, styles$U.tooltip({
          cornerPositionX: cornerPositionX
...
var UriLabel = function UriLabel(_ref) {
  var className = _ref.className,
      uri = _ref.uri;
  return createElement("div", {
    className: cx(styles$V.uriWrap, className)
