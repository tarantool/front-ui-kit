...
var styles$13 = {
  block: /*#__PURE__*/css("max-width:100%;padding:20px;border-radius:10px;overflow:auto;background-color:", colors.dark, ";color:white;"),
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/createElement("div", {
        ...
        className: cx$1(commonInputStyles.input, commonInputSizes[size || 'l'], (_cx2 = {}, _defineProperty(_cx2, styles$1a.inputWithAddition, hasAddition), _defineProperty(_cx2, styles$1a.inputWithIcon, rightIcon || onClearClick), _defineProperty(_cx2, commonInputStyles.disabled, disabled), _cx2)),
        disabled: disabled,
        name: name,
        onChange: onChange,
        onKeyDown: onKeyDown,
