...
var styles = {
  alert:
  /*#__PURE__*/
  emotion.css("padding:15px;border:1px solid;border-radius:4px;margin-top:16px;margin-bottom:16px;"),
  success:
  /*#__PURE__*/
  emotion.css("border-color:", colors.intentSuccessBorder, ";background-color:", colors.intentSuccessBg, ";color:", colors.intentSuccess, ";"),
  error:
  /*#__PURE__*/
  emotion.css("border-color:", colors.intentDangerBorder, ";background-color:", colors.intentDangerBg, ";color:", colors.intentDanger, ";")
};
...
var styles$X = {
  breadcrumbs:
  /*#__PURE__*/
  emotion.css("display:flex;align-items:baseline;width:100%;overflow:hidden;"),
  breadcrumbElement:
  /*#__PURE__*/
...
var styles$Z = {
  header:
  /*#__PURE__*/
  styled.css("height:68px;background:#ffffff;width:100%;display:flex;padding:0 30px;box-sizing:border-box;flex-direction:row;justify-content:space-between;align-items:center;"),
  crumbs:
  /*#__PURE__*/
  styled.css("display:flex;flex-grow:1;flex-shrink:1;flex-direction:row;flex-wrap:nowrap;align-items:center;"),
  controls:
  /*#__PURE__*/
  styled.css("display:flex;flex-basis:auto;flex-grow:0;flex-shrink:0;flex-direction:row;flex-wrap:nowrap;align-items:center;margin-left:20px;")
};
...
var styles$_ = {
  main:
  /*#__PURE__*/
  emotion.css("display:flex;flex-grow:1;flex-shrink:0;flex-direction:row;flex-wrap:nowrap;justify-content:flex-start;align-items:stretch;position:relative;max-width:100vw;height:100vh;margin:0 auto;"),
  content:
  /*#__PURE__*/
  emotion.css("display:block;background:", colors.baseBg, ";flex-grow:1;max-height:100vh;overflow:auto;"),
  sidebar:
  /*#__PURE__*/
  emotion.css("flex-grow:0;flex-shrink:0;box-sizing:border-box;z-index:1;")
};
...
var styles$17 = {
  ...
  input:
  /*#__PURE__*/
  emotion.css("margin:6px 16px 6px;"),
  column:
  /*#__PURE__*/
  emotion.css("align-self:stretch;margin:0 16px;"),
  columnInput:
  /*#__PURE__*/
  emotion.css("margin-top:6px;margin-bottom:6px;"),
  columns: [
  /*#__PURE__*/
...
var commonFormFieldStyles = {
  wrap:
  /*#__PURE__*/
  emotion.css("margin-bottom:10px;"),
  wrapMargin:
  /*#__PURE__*/
  ...
  headingPane:
  /*#__PURE__*/
  emotion.css("display:flex;flex-direction:row;align-items:center;height:22px;margin-bottom:0;"),
  headingPaneMargin:
  /*#__PURE__*/
  emotion.css("margin-bottom:10px;"),
  headingPaneLeft:
...
var commonInputStyles = {
  ...
  disabled:
  /*#__PURE__*/
  styled.css("background-color:", colors.dark2, ";"),
  focused:
  /*#__PURE__*/
  styled.css("border-color:", colors.dark40, ";"),
  error:
  /*#__PURE__*/
  styled.css("border-color:", colors.intentDanger, ";"),
  input:
  /*#__PURE__*/
...
var commonInputSizes = {
  m:
  /*#__PURE__*/
  styled.css("padding-top:5px;padding-bottom:5px;"),
  l:
  /*#__PURE__*/
  styled.css("padding-top:9px;padding-bottom:9px;")
};
...
var styles$19 = {
  ...
  inputWithIcon:
  /*#__PURE__*/
  styled.css("padding-left:15px;padding-right:8px;"),
  iconWrap:
  /*#__PURE__*/
  styled.css("display:flex;align-items:center;"),
  withLeftElement:
  /*#__PURE__*/
...
var wrapSizes = {
  m:
  /*#__PURE__*/
  styled.css("height:32px;"),
  l:
  /*#__PURE__*/
  styled.css("height:40px;")
};
var iconWrapSizes = {
  m:
  /*#__PURE__*/
  styled.css("margin-right:7px;"),
  l:
  /*#__PURE__*/
  styled.css("margin-right:15px;")
};
...
var styles$1i = {
  ...
  pageWithAbovePanel:
  /*#__PURE__*/
  emotion.css("margin-top:20px;"),
  wide:
  /*#__PURE__*/
  emotion.css("max-width:none;"),
  aboveHeadingPanel:
  /*#__PURE__*/
  emotion.css("flex-shrink:0;margin:0 0 20px;"),
  headingPanel:
  /*#__PURE__*/
  emotion.css("display:flex;justify-content:flex-end;align-items:baseline;margin-bottom:15px;"),
  leftControls:
  /*#__PURE__*/
  emotion.css("align-self:center;margin-left:40px;"),
  rightControls:
  /*#__PURE__*/
  emotion.css("align-self:center;"),
  divider:
  /*#__PURE__*/
...
var PageLayout = function PageLayout(_ref) {
  ...
  return (
    ...
    /*#__PURE__*/
    React.createElement(AboveComponent, {
...
var styles$1k = {
  ...
  button:
  /*#__PURE__*/
  emotion.css("min-width:32px;height:32px;background:#FFFFFF;border:1px solid #D9D9D9;box-sizing:border-box;border-radius:4px;color:rgba(0,0,0,0.65);font-size:14px;text-align:center;padding:4px;margin:0 4px;"),
  buttonActive:
  /*#__PURE__*/
...
var styles$1s = {
  ...
  tab:
  /*#__PURE__*/
  emotion.css("position:relative;padding:14px 0;border:none;margin-right:30px;margin-bottom:-1px;border-bottom:solid 2px transparent;color:", colors.dark40, ";background-color:transparent;outline:none;cursor:pointer;&:hover,&:focus{z-index:", zIndex.inline, ";color:", colors.dark65, ";}&:last-child{margin-right:0;}"),
  activeTab:
  /*#__PURE__*/
  emotion.css("color:", colors.baseHeading, ";border-bottom-color:", colors.baseHeading, ";"),
  tabs:
  /*#__PURE__*/
  emotion.css("border-bottom:solid 1px ", colors.intentBase, ";")
};
var Tabbed =
/*#__PURE__*/
function (_React$Component) {
...
var styles$1y = {
  ...
  icon:
  /*#__PURE__*/
  emotion.css("width:48px;height:48px;margin-bottom:16px;fill:", colors.intentBase, ";"),
  notice:
  /*#__PURE__*/
  emotion.css("margin-top:10px;color:", colors.dark65, ";")
};
