...
var NotificationSplash = function NotificationSplash(_ref) {
  ...
  return React.createElement("div", {
    className: emotion.cx(styles$L.splash, _defineProperty({}, styles$L.closePadding, onClose), className)
  }, React.createElement(Text, {
    className: styles$L.children,
    tag: "span"
  }, children), React.createElement(ControlsPanel, {
    className: emotion.cx(styles$L.controls, _defineProperty({}, styles$L.controlsMargin, children && controls)),
    controls: controls
  ...
  _createClass(Spin, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: emotion.cx(styles$M.container, {
          'blur': enable
        })
      }, children));
    }
    ...
    value: function renderSpin() {
      return React.createElement("div", {
        ...
        className: emotion.cx(styles$M.rect, 'rect2')
      }), React.createElement("div", {
        className: emotion.cx(styles$M.rect, 'rect3')
      }), React.createElement("div", {
        className: emotion.cx(styles$M.rect, 'rect4')
      }), React.createElement("div", {
        className: emotion.cx(styles$M.rect, 'rect5')
      })));
    }
  }]);
...
var PageCard = function PageCard(_ref) {
  ...
  return React.createElement("div", {
    className: styled.cx(styles$N.container, // { [styles.corner]: showCorner },
    className)
...
var PageLayout = function PageLayout(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return React.createElement("div", {
    className: emotion.cx(styles$O.page, className)
  }, children);
};
...
var PageSection = function PageSection(_ref) {
  ...
  return React.createElement("section", {
    className: emotion.cx(styles$P.section, className)
  }, isHeadingPaneVisible && React.createElement("div", {
    className: emotion.cx(styles$P.headingPane, _defineProperty({}, styles$P.headingPaneMargin, children))
...
var PopupBody = function PopupBody(_ref) {
  ...
  return scrollable ? React.createElement(Scrollbar, {
    className: emotion.cx(styles$Q.scrollableWrap, className)
  }, React.createElement("div", {
    className: emotion.cx(styles$Q.scrollableBody, innerClassName)
  }, children)) : React.createElement("div", {
...
var RadioButton = function RadioButton(_ref) {
  var checked = _ref.checked,
      ...
      value = _ref.value;
  return React.createElement("label", {
    className: emotion.cx(styles$R.label, className)
  }, React.createElement("input", {
    checked: checked,
    ...
    className: emotion.cx(styles$R.iconWrap, _defineProperty({}, styles$R.childrenMargin, children))
...
var Switcher = function Switcher(_ref) {
  ...
  return React.createElement("label", {
    ...
    className: emotion.cx(styles$S.switcher, (_cx = {}, _defineProperty(_cx, styles$S.notDisabled, !checked && !disabled), _defineProperty(_cx, styles$S.checked, checked && !disabled), _defineProperty(_cx, styles$S.disabled, !checked && disabled), _defineProperty(_cx, styles$S.basicDisabled, disabled), _defineProperty(_cx, styles$S.checkedDisabled, checked && disabled), _defineProperty(_cx, styles$S.childrenMargin, children), _cx))
  }), typeof children === 'string' ? React.createElement(Text, {
  ...
  _createClass(Tabbed, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        return React.createElement("button", {
          className: emotion.cx(styles$T.tab, _defineProperty({}, styles$T.activeTab, activeTab === i)),
...
var Tag = function Tag(_ref) {
  ...
  return React.createElement(Element, {
    className: emotion.cx((_cx = {}, _defineProperty(_cx, styles$U.interactive(highlightingOnHover), !!highlightingOnHover), _defineProperty(_cx, styles$U["static"], !highlightingOnHover), _defineProperty(_cx, styles$U.pointer, onClick), _cx), styles$U.tag, className),
    onClick: onClick
  }, text);
};
...
var TagsList = function TagsList(_ref) {
  var className = _ref.className,
      ...
      values = _ref.values;
  return React__default.createElement("div", {
    className: emotion.cx(styles$V.wrapper, className)
    ...
    return React__default.createElement(Tag, {
      className: emotion.cx(styles$V.tag, tagClassName),
      onClick: function onClick() {
...
var TiledListItem = function TiledListItem(_ref2) {
  var className = _ref2.className,
      ...
      render = _ref2.render;
  return React.createElement("li", {
    className: styled.cx(styles$W.item, _defineProperty({}, styles$W.softCorners, corners === 'soft'), className)
  }, render(item));
};
...
var TiledList = function TiledList(_ref3) {
  ...
  return React.createElement("ul", {
    className: styled.cx(styles$W.outer({
      outer: outer
    }), className)
  }, items && items.map(function (item) {
...
var UriLabel = function UriLabel(_ref) {
  var className = _ref.className,
      uri = _ref.uri;
  return React.createElement("div", {
    className: emotion.cx(styles$X.uriWrap, className)
