...
var styles$U = {
  breadcrumbElement:
  /*#__PURE__*/
  emotion.css("color:", colors.dark40, ";font-size:16px;line-height:22px;white-space:nowrap;"),
...
var styles$V = {
  ...
  breadcrumbDelimeter:
  /*#__PURE__*/
  emotion.css("margin:0 6px;color:", colors.dark40, ";font-size:16px;line-height:22px;white-space:nowrap;"),
  appName:
  /*#__PURE__*/
  ...
  overflowButton:
  /*#__PURE__*/
  emotion.css("cursor:pointer;font-size:16px;line-height:22px;color:#8E9199;&:hover{text-decoration-line:underline;}")
};
