  ...
  _createClass(Spin, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: emotion.cx(styles$D.container, {
          'blur': enable
        })
      }, children));
    }
    ...
    value: function renderSpin() {
      return React.createElement("div", {
        ...
        className: emotion.cx(styles$D.rect, 'rect2')
      }), React.createElement("div", {
        className: emotion.cx(styles$D.rect, 'rect3')
      }), React.createElement("div", {
        className: emotion.cx(styles$D.rect, 'rect4')
      }), React.createElement("div", {
        className: emotion.cx(styles$D.rect, 'rect5')
      })));
    }
  }]);
...
var PageCard = function PageCard(_ref) {
  ...
  return React.createElement("div", {
    className: styled.cx(styles$E.container, // { [styles.corner]: showCorner },
    className)
...
var PageLayout = function PageLayout(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return React.createElement("div", {
    className: emotion.cx(styles$F.page, className)
  }, children);
};
...
var PageSection = function PageSection(_ref) {
  ...
  return React.createElement("section", {
    className: emotion.cx(styles$G.section, className)
  }, isHeadingPaneVisible && React.createElement("div", {
    className: emotion.cx(styles$G.headingPane, _defineProperty({}, styles$G.headingPaneMargin, children))
...
var PopupBody = function PopupBody(_ref) {
  ...
  return scrollable ? React.createElement(Scrollbar, {
    className: emotion.cx(styles$H.scrollableWrap, className)
  }, React.createElement("div", {
    className: emotion.cx(styles$H.scrollableBody, innerClassName)
  }, children)) : React.createElement("div", {
...
var RadioButton = function RadioButton(_ref) {
  var checked = _ref.checked,
      ...
      value = _ref.value;
  return React.createElement("label", {
    className: emotion.cx(styles$I.label, className)
  }, React.createElement("input", {
    checked: checked,
    ...
    className: emotion.cx(styles$I.iconWrap, _defineProperty({}, styles$I.childrenMargin, children))
...
var Switcher = function Switcher(_ref) {
  ...
  return React.createElement("label", {
    ...
    className: emotion.cx(styles$J.switcher, (_cx = {}, _defineProperty(_cx, styles$J.notDisabled, !checked && !disabled), _defineProperty(_cx, styles$J.checked, checked && !disabled), _defineProperty(_cx, styles$J.disabled, !checked && disabled), _defineProperty(_cx, styles$J.basicDisabled, disabled), _defineProperty(_cx, styles$J.checkedDisabled, checked && disabled), _defineProperty(_cx, styles$J.childrenMargin, children), _cx))
  }), typeof children === 'string' ? React.createElement(Text, {
  ...
  _createClass(Tabbed, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        return React.createElement("button", {
          className: emotion.cx(styles$K.tab, _defineProperty({}, styles$K.activeTab, activeTab === i)),
...
var Tag = function Tag(_ref) {
  ...
  return React.createElement(Element, {
    className: emotion.cx((_cx = {}, _defineProperty(_cx, styles$L.interactive(highlightingOnHover), !!highlightingOnHover), _defineProperty(_cx, styles$L["static"], !highlightingOnHover), _defineProperty(_cx, styles$L.pointer, onClick), _cx), styles$L.tag, className),
    onClick: onClick
  }, text);
};
...
var TagsList = function TagsList(_ref) {
  var className = _ref.className,
      ...
      values = _ref.values;
  return React__default.createElement("div", {
    className: emotion.cx(styles$M.wrapper, className)
    ...
    return React__default.createElement(Tag, {
      className: emotion.cx(styles$M.tag, tagClassName),
      onClick: function onClick() {
...
var TiledListItem = function TiledListItem(_ref2) {
  var className = _ref2.className,
      ...
      render = _ref2.render;
  return React.createElement("li", {
    className: styled.cx(styles$N.item, _defineProperty({}, styles$N.softCorners, corners === 'soft'), className)
  }, render(item));
};
...
var TiledList = function TiledList(_ref3) {
  ...
  return React.createElement("ul", {
    className: styled.cx(styles$N.outer({
      outer: outer
    }), className)
  }, items && items.map(function (item) {
...
var UriLabel = function UriLabel(_ref) {
  var className = _ref.className,
      uri = _ref.uri;
  return React.createElement("div", {
    className: emotion.cx(styles$O.uriWrap, className)
