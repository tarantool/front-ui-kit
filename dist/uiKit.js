...
var Button = function Button(_ref) {
  ...
  return React.createElement("button", {
    className: styled.cx(styles$2.button, styles$2[intent], (_cx2 = {}, _defineProperty(_cx2, styles$2.iconicM, isOnlyIcon && size === 'm'), _defineProperty(_cx2, styles$2.iconicS, isOnlyIcon && size === 's'), _defineProperty(_cx2, styles$2.m, !isOnlyIcon && size === 'm'), _defineProperty(_cx2, styles$2.s, !isOnlyIcon && size === 's'), _cx2), className),
    disabled: disabled,
    onClick: onClick,
    type: type
  }, content);
