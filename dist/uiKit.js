  ...
  _createClass(BaseModal, [{
    ...
    value: function renderModal() {
      ...
      return React.createElement("div", {
        className: emotion.cx(styles$1.shim({
          bg: bgColor
        }), shimClassName),
    ...
    _createClass(_class, [{
      ...
      value: function render() {
        ...
        return React.createElement(React.Fragment, null, React.createElement(Component, Object.assign({}, props, {
          className: emotion.cx(styles$x.wrapper, className),
      ...
      value: function renderTooltip() {
        ...
        return React.createElement("div", {
          className: emotion.cx(textStyles.p, styles$x.tooltip({
            cornerPositionX: cornerPositionX
...
var styles$y = {
  wrap:
  /*#__PURE__*/
  emotion.css("position:relative;& > button{transition:opacity ease-in-out 0.3s;}& > button:not(:focus){opacity:0;}&:hover > button{opacity:1;}"),
  copyBtn:
  /*#__PURE__*/
  emotion.css("position:absolute;top:0;right:0;")
};
var CodeBlock =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(CodeBlock, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        ref: this.ref,
        className: emotion.cx(textStyles.code, theme, _defineProperty({}, "language-".concat(language), language))
      }, text), React.createElement(CopyToClipboard, {
...
var PopupFooter = function PopupFooter(_ref) {
  ...
  return React.createElement("div", {
    className: emotion.cx(styles$A.wrap, className)
  }, children, controls && React.createElement(ControlsPanel, {
    className: emotion.cx(styles$A.controls),
    controls: controls,
    thin: true
  }));
};
  ...
  _createClass(Modal, [{
    ...
    value: function renderModal() {
      ...
      return React.createElement("div", {
        ...
        className: emotion.cx(styles$1.baseModal, styles$B.modal, (_cx = {}, _defineProperty(_cx, styles$B.fit, fit), _defineProperty(_cx, styles$1.wide, wide), _cx), className),
        ref: this.modalRef,
        tabIndex: 0,
        onKeyDown: this.handleEscapePress
...
var Divider = function Divider(_ref) {
  ...
  return React__default.createElement("div", {
    className: emotion.cx(styles$C.divider, className)
  });
};
...
function (_React$Component) {
  ...
  function Dropdown() {
    ...
    _this.renderPopover = function () {
      ...
      return React.createElement("ul", {
        className: emotion.cx(styles$D.popover, _defineProperty({}, styles$D.popoverToLeft, toLeft), popoverClassName),
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var isOpen = this.state.isOpen;
      return React.createElement("div", {
        className: emotion.cx(styles$D.wrap, className),
        onClick: this.handleClick,
        ref: this.wrapRef
      }, React.createElement(Component, null), isOpen && items && this.renderPopover());
    }
  }]);
...
var DropdownItem = function DropdownItem(_ref2) {
  ...
  return React.createElement("li", Object.assign({}, props, {
    className: emotion.cx(textStyles.basic, styles$D.item(color), className)
  }), children);
};
...
var DotIndicator = function DotIndicator(_ref) {
  ...
  return React__default.createElement("span", {
    className: emotion.cx(styles$E.indicator, styles$E.state[state], styles$E.size.s, className)
  });
};
...
var FlatListItem = function FlatListItem(_ref) {
  ...
  return React.createElement("li", {
    className: emotion.cx(styles$F.item, className)
  }, render(item));
};
...
var HealthStatus = function HealthStatus(_ref) {
  var className = _ref.className,
      ...
      title = _ref.title;
  return React.createElement(Text, {
    className: emotion.cx(styles$I.status, className),
    variant: "p",
    tag: "div",
    title: title
...
function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        className: styled.cx(styles$J.outer, (_cx = {}, _defineProperty(_cx, styles$J.disabled, disabled), _defineProperty(_cx, styles$J.focused, focused), _defineProperty(_cx, styles$J.error, error), _cx), className),
        title: title
      }, React.createElement("input", Object.assign({
        autoFocus: autoFocus,
        autoComplete: autoComplete,
        className: styled.cx(styles$J.input, _defineProperty({}, styles$J.inputWithIcon, rightIcon || onClearClick)),
        disabled: disabled,
        name: name,
        onChange: onChange,
        onKeyDown: onKeyDown,
...
var LabeledInput = function LabeledInput(_ref) {
  var children = _ref.children,
      ...
      label = _ref.label;
  return React.createElement("label", {
    className: emotion.cx(styles$K.wrap, className)
  }, React.createElement("div", {
...
var LeaderFlagSmall = function LeaderFlagSmall(_ref) {
  ...
  return React.createElement("svg", {
    ...
    className: emotion.cx(styles$M.flag, className)
  }, React.createElement("use", {
...
var Link = function Link(_ref) {
  ...
  return React.createElement("a", {
    className: emotion.cx(styles$N.link, className),
    href: href,
    onClick: onClick,
    target: target,
    title: title
...
var NonIdealState = function NonIdealState(_ref) {
  var children = _ref.children,
      ...
      title = _ref.title;
  return React.createElement("div", {
    className: emotion.cx(styles$P.wrap, className)
  }, Icon ? React.createElement(Icon, {
    className: emotion.cx(styles$P.icon, _defineProperty({}, styles$P.iconMargin, title))
...
var NotificationSplash = function NotificationSplash(_ref) {
  ...
  return React.createElement("div", {
    className: emotion.cx(styles$Q.splash, _defineProperty({}, styles$Q.closePadding, onClose), className)
  }, React.createElement(Text, {
    className: styles$Q.children,
    tag: "span"
  }, children), React.createElement(ControlsPanel, {
    className: emotion.cx(styles$Q.controls, _defineProperty({}, styles$Q.controlsMargin, children && controls)),
    controls: controls
  ...
  _createClass(NotificationSplashFixed, [{
    ...
    value: function renderSplash() {
      ...
      return React.createElement(NotificationSplash, {
        className: emotion.cx(styles$R.splash, className),
        controls: controls,
        onClose: onClose
      }, children);
    }
  ...
  _createClass(Spin, [{
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        className: emotion.cx(styles$S.container, {
          'blur': enable
        })
      }, children));
    }
    ...
    value: function renderSpin() {
      return React.createElement("div", {
        ...
        className: emotion.cx(styles$S.rect, 'rect2')
      }), React.createElement("div", {
        className: emotion.cx(styles$S.rect, 'rect3')
      }), React.createElement("div", {
        className: emotion.cx(styles$S.rect, 'rect4')
      }), React.createElement("div", {
        className: emotion.cx(styles$S.rect, 'rect5')
      })));
    }
  }]);
...
var PageCard = function PageCard(_ref) {
  ...
  return React.createElement("div", {
    className: styled.cx(styles$T.container, // { [styles.corner]: showCorner },
    className)
...
var PageLayout = function PageLayout(_ref) {
  var children = _ref.children,
      className = _ref.className;
  return React.createElement("div", {
    className: emotion.cx(styles$U.page, className)
  }, children);
};
...
var PageSection = function PageSection(_ref) {
  ...
  return React.createElement("section", {
    className: emotion.cx(styles$V.section, className)
  }, isHeadingPaneVisible && React.createElement("div", {
    className: emotion.cx(styles$V.headingPane, _defineProperty({}, styles$V.headingPaneMargin, children))
...
var PopupBody = function PopupBody(_ref) {
  ...
  return scrollable ? React.createElement(Scrollbar, {
    className: emotion.cx(styles$W.scrollableWrap, className)
  }, React.createElement("div", {
    className: emotion.cx(styles$W.scrollableBody, innerClassName)
  }, children)) : React.createElement("div", {
...
var RadioButton = function RadioButton(_ref) {
  ...
  return React.createElement("label", {
    ...
    className: emotion.cx(styles$X.iconWrap, _defineProperty({}, styles$X.childrenMargin, children))
...
var Switcher = function Switcher(_ref) {
  ...
  return React.createElement("label", {
    ...
    className: emotion.cx(styles$Y.switcher, (_cx = {}, _defineProperty(_cx, styles$Y.notDisabled, !checked && !disabled), _defineProperty(_cx, styles$Y.checked, checked && !disabled), _defineProperty(_cx, styles$Y.disabled, !checked && disabled), _defineProperty(_cx, styles$Y.basicDisabled, disabled), _defineProperty(_cx, styles$Y.checkedDisabled, checked && disabled), _defineProperty(_cx, styles$Y.childrenMargin, children), _cx))
  }), typeof children === 'string' ? React.createElement(Text, {
    ...
    value: function render() {
      ...
      return React.createElement("div", {
        ...
        return React.createElement("button", {
          className: emotion.cx(styles$Z.tab, _defineProperty({}, styles$Z.activeTab, activeTab === i)),
          onClick: function onClick() {
...
var Tag = function Tag(_ref) {
  ...
  return React.createElement(Element, {
    className: emotion.cx((_cx = {}, _defineProperty(_cx, styles$_.interactive(highlightingOnHover), !!highlightingOnHover), _defineProperty(_cx, styles$_["static"], !highlightingOnHover), _defineProperty(_cx, styles$_.pointer, onClick), _cx), styles$_.tag, className),
    onClick: onClick,
    title: title
  }, text);
};
...
var TagsList = function TagsList(_ref) {
  var className = _ref.className,
      ...
      values = _ref.values;
  return React__default.createElement("div", {
    className: emotion.cx(styles$$.wrapper, className)
    ...
    return React__default.createElement(Tag, {
      className: emotion.cx(styles$$.tag, tagClassName),
      onClick: function onClick() {
...
var TiledListItem = function TiledListItem(_ref2) {
  var className = _ref2.className,
      ...
      render = _ref2.render;
  return React.createElement("li", {
    className: styled.cx(styles$10.item, _defineProperty({}, styles$10.softCorners, corners === 'soft'), className)
  }, render(item));
};
...
var TiledList = function TiledList(_ref3) {
  ...
  return React.createElement("ul", {
    className: styled.cx(styles$10.outer({
      outer: outer
    }), className)
  }, items && items.map(function (item) {
...
var UriLabel = function UriLabel(_ref) {
  var className = _ref.className,
      ...
      uri = _ref.uri;
  return React.createElement("div", {
    className: emotion.cx(styles$11.uriWrap, className),
    title: title
